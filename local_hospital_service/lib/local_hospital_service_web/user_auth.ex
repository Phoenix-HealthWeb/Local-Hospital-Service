defmodule LocalHospitalServiceWeb.UserAuth do
  use LocalHospitalServiceWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_local_hospital_service_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      LocalHospitalServiceWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule LocalHospitalServiceWeb.PageLive do
        use LocalHospitalServiceWeb, :live_view

        on_mount {LocalHospitalServiceWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{LocalHospitalServiceWeb.UserAuth, :ensure_authenticated}] do
