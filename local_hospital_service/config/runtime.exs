...
#
#     PHX_SERVER=true bin/local_hospital_service start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :local_hospital_service, LocalHospitalServiceWeb.Endpoint, server: true
end
...
config :local_hospital_service, LocalHospitalService.Api,
  ...
  ndb_api_hospital_id: System.fetch_env!("NDB_API_HOSPITAL_ID")
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/local_hospital_service/local_hospital_service.db
      """
  ...
  #
  #     config :local_hospital_service, LocalHospitalService.Mailer,
